...
#include "sensor_thread.h"
                ...
                static uint8_t sensor_thread_stack[2048] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #else
                static uint8_t sensor_thread_stack[2048] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX ".stack.sensor_thread") BSP_ALIGN_VARIABLE(BSP_STACK_ALIGNMENT);
                #endif
                #endif
...
/* I2C Communication Device */
rm_comms_i2c_instance_ctrl_t g_zmod_comms_i2c_ctrl;

/* Lower level driver configuration */
const i2c_master_cfg_t g_zmod_comms_i2c_lower_level_cfg =
{
    .slave = 0x33,
    .addr_mode = I2C_MASTER_ADDR_MODE_7BIT,
    .p_callback = rm_comms_i2c_callback,
...
const rm_comms_instance_t g_zmod_comms_i2c =
{
    .p_ctrl = &g_zmod_comms_i2c_ctrl,
    .p_cfg  = &g_zmod_comms_i2c_cfg,
    .p_api  = &g_comms_on_comms_i2c,
};
