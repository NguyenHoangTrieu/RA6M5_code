...
static uint8_t
    sensor_thread_stack[2048] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX
                                                   ".stack.thread")
...
#endif
      sensor_thread_func, (const char *)"Sensor Thread",
      2048 / 4,                          // In words, not bytes
      (void *)&sensor_thread_parameters, // pvParameters
      4,
#if 1
      (StackType_t *)&sensor_thread_stack, (StaticTask_t *)&sensor_thread_memory
#else
      &sensor_thread
#endif
  );
