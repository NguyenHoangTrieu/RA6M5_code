...
static uint8_t
    blinky_thread_stack[512] BSP_PLACE_IN_SECTION(BSP_UNINIT_SECTION_PREFIX
                                                  ".stack.thread")
...
#endif
      blinky_thread_func, (const char *)"Blinky Thread",
      512 / 4,                           // In words, not bytes
      (void *)&blinky_thread_parameters, // pvParameters
      1,
#if 1
      (StackType_t *)&blinky_thread_stack, (StaticTask_t *)&blinky_thread_memory
#else
      &blinky_thread
#endif
  );
